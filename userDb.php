...
//            echo $query;
    ...
    function updateAdminProfile($ar, $userid)
    {
        try {
            $query = "UPDATE user SET fname = '" . $ar['fname'] . "', lname = '" . $ar['lname'] . "',type = ".$ar['type']." WHERE userid = $userid";
            $this->getConnent()->query($query);
...
//            echo $query;
    ...
    {
        try {
            $query = "SELECT type FROM user WHERE email = '$email' AND status = 1";
            $result = $this->getConnent()->query($query);
            $result = $result->fetchAll();
//            echo $query;
            return $result[0][0];
    ...
    {
        try {
            $query = "SELECT pic FROM user WHERE email = '$email' AND status = 1";
            $result = $this->getConnent()->query($query);
            $result = $result->fetchAll();
//            echo $query;
            return $result[0][0];
